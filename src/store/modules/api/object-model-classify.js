        ...
        collectedModelIds.forEach(modelId => {
            ...
            if (model) {
                ...
                resources.push({
                    ...
                    path: `/general-model/${modelId}`,
                    authorized: true,
                    classificationId: resourcesKey
                })
            }

        })
         STATIC_NAVIGATION[collectionKey].children = collection
         STATIC_NAVIGATION[resourcesKey].children = resources
         STATIC_NAVIGATION[resourcesKey].children.push({
            "i18n": "Nav['业务']",
            "path": "/business",
            "id": "biz",
            "name": "业务",
            "authorized": true,
            "classificationId": "bk_basic_resources"
        }, {
            "i18n": "Nav['主机']",
            "path": "/resource",
            "id": "resource",
