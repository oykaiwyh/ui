        ...
        computed: {
            ...
            */
            localClassifications () {
                ...
                this.classifications.forEach(classification => {
                    ...
                    if (classification['bk_classification_id'] === 'bk_host_manage') {
                        ...
                        /*
                          过滤两个主机上的模行
                        */
                         currentClassification['bk_objects'] = classification['bk_objects'].filter(({bk_obj_id: objId}) =>{
                             return !['process', 'plat'].includes(objId)                            
                         })                      
                ...
                /*
                   过滤'bk_biz_topo', 'bk_host_manage', 'bk_organization' 这个三个唯一表示不能新建模型
                */
               ...
               this.modelDialog.classificationList = localClassifications
